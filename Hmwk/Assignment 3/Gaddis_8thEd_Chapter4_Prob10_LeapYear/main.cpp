 ...
 * Created on November 3rd, 2016, 9:44 AM
 * Purpose:  Leap Year
 */
...
int main(int argc, char** argv) {
    ...
    switch(month){
        ...
        case 2: {
            ...
            }else if(year%400==0) cout<<"There are 29 days in February, "<<year<<endl;
                    (year%100==0); cout<<"There are 28 days in February, "<<year<<endl;
